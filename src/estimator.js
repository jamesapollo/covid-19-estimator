const covid19ImpactEstimator = (data) => {
  ...
  const impactSevereCases = Math.ceil(impact.infectionsByRequestedTime * 0.15);
  const severeImpactSevereCases = Math.ceil(severeImpact.infectionsByRequestedTime * 0.15);
